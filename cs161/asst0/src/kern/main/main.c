...
boot(void)
{
	...
	kprintf("Group 4's system version %s (%s #%d)\n", 
		GROUP_VERSION, buildconfig, buildversion);
	kprintf("\n");
	DEBUG(DB_LOCORE, "LOCORE flag set\n");
	DEBUG(DB_SYSCALL, "SYSCALL flag set\n");
	DEBUG(DB_INTERRUPT, "INTERRUPT flag set\n");
	DEBUG(DB_DEVICE, "DEVICE flag set\n");
	DEBUG(DB_THREADS, "THREADS flag set\n");
	DEBUG(DB_VM, "VM flag set\n");
	DEBUG(DB_EXEC, "EXEC flag set\n");
	DEBUG(DB_VFS, "VFS flag set\n");
	DEBUG(DB_SFS, "SFS flag set\n");
	DEBUG(DB_NET, "NET flat set\n");
