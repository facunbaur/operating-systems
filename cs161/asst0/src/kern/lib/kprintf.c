...
u_int32_t dbflags = DB_LOCORE;
u_int32_t dbflags_1 = DB_SYSCALL;
u_int32_t dbflags_2 = DB_INTERRUPT;
u_int32_t dbflags_3 = DB_DEVICE;
u_int32_t dbflags_4 = DB_THREADS;
u_int32_t dbflags_5 = DB_VM;
u_int32_t dbflags_6 = DB_EXEC;
u_int32_t dbflags_7 = DB_VFS;
u_int32_t dbflags_8 = DB_SFS;
u_int32_t dbflags_9 = DB_NET;
